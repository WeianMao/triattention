...
usage() {
  cat <<USAGE
Usage: bash scripts/distill_qwen7b/run_speckv_per_head.sh [--budget N]

Runs SpeckV per-head pruning for DeepSeek-R1-Distill-Qwen-7B on aime24/aime25/math500. Passing
