...
usage() {
  cat <<USAGE
Usage: bash scripts/distill_qwen7b/run_speckv_per_layer_head.sh [--budget N]

Runs per-layer+per-head SpeckV pruning for DeepSeek-R1-Distill-Qwen-7B on aime24/aime25/math500.
