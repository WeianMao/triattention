BENCHMARK="math" # "gsm8k", "math", "aime"
...
MAX_NEW_TOKENS=8192 # # llama: 4096 for gsm8k, 8192 for math, 16384 for aime
EVAL_BATCH_SIZE=1 # 1 
TEMPERATURE=0.0
SEED=42

#KV Compression Settings
method=Window_LAZY # FullKV Window_LAZY
max_kv_capacity=1334 
attn_implementation="eager" # Support "eager"
decoding_recent_size=52  #27, 52, 95
