...
MAX_NEW_TOKENS=16384 # qwen: 4096 for gsm8k, 8192 for math, 16384 for aime
EVAL_BATCH_SIZE=1 
TEMPERATURE=0.0
SEED=42
...
decoding_recent_size=363   # gsm 101; math 175; aime 363

OUPTUT_DIR="outputs/DeepSeek-R1-Distill-Qwen-7B/${BENCHMARK}"  

CUDA_VISIBLE_DEVICES=0 python ../weian_development/lazy_eviction_runner.py --output-dir ${OUPTUT_DIR} --model-path ${MODEL_PATH} --tokenizer-path ${MODEL_PATH} \
