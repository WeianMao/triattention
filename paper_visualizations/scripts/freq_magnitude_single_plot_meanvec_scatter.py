"""Scatter visualization of centered Q/K offsets for top-magnitude RoPE frequencies."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--top-k", type=int, default=6, help="Number of frequencies to scatter")
