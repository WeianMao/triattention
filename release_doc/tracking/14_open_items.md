...
**校准 Stats**：已确认 — 混合方案（预生成 + raw text 脚本）。详见 [../components/calibration_stats.md](../components/calibration_stats.md)

**sys.path 清理**：已确认 — 完善 setup.py + 删除 hack。详见 [../code_cleanup/syspath_cleanup.md](../code_cleanup/syspath_cleanup.md)
