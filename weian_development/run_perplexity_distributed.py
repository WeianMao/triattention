"""Distribute reasoning perplexity evaluation across multiple GPUs with dynamic scheduling."""
...
from compute_reasoning_perplexity import (  # noqa: E402
    PerplexityConfig,
    PerplexityEvaluator,
    list_json_files,
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run reasoning perplexity across multiple GPUs")
    ...
    parser.add_argument("--gpus", default="0", help="Comma-separated list of GPU indices")
