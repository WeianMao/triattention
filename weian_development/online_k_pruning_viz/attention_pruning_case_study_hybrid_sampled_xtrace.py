"""Run hybrid frequency-based key pruning across sampled heads with cross-trace stats."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        type=Path,
        default=None,
        help="Base directory for outputs (defaults to <input_root>/../attention_pruning_case_studies_hybrid_sampled_xtrace).",
    )
    parser.add_argument(
        "--stats-trace",
        type=Path,
...
def main() -> None:
    ...
    if output_root is None:
        output_root = args.input_root.parent / "attention_pruning_case_studies_hybrid_sampled_xtrace"
