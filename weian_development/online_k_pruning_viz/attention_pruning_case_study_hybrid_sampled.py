"""Run hybrid frequency-based key pruning across a sampled set of heads."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Visualize hybrid frequency scoring on a sampled collection of heads.",
    )
    parser.add_argument(
        "input_root",
        type=Path,
    ...
    parser.add_argument(
        ...
        type=Path,
        default=None,
        help="Base directory for outputs (defaults to <input_root>/../attention_pruning_case_studies_hybrid_sampled).",
    )
    parser.add_argument(
        "--target-size",
        type=int,
...
def main() -> None:
    ...
    if output_root is None:
        output_root = args.input_root.parent / "attention_pruning_case_studies_hybrid_sampled"
