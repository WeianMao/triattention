"""
Module 2 Experiment Runner with Probe Activation Loss Ablation
...
def main():
    """Main entry point."""
    parser = argparse.ArgumentParser(description='Module 2 Experiment Runner with Probe Activation Loss Ablation')
    parser.add_argument(
        '--mode',
        type=str,
        choices=['train', 'evaluate', 'all', 'ablation'],
        default='all',
        help='Execution mode: train, evaluate, all, or ablation (default: all)'
    )
    parser.add_argument(
        '--checkpoint',
        type=str,
