#!/usr/bin/env python3
"""Test full compression with Qwen model and real stats."""
import sys
...
def main():
    print("Testing full compression with Qwen model and real stats...")
    ...
    sampling_params = SamplingParams(
        temperature=0.6,
        top_p=0.95,
        max_tokens=500,  # Generate enough to trigger compression
    )

    prompts = ["What is 2 + 2? Think step by step."]
