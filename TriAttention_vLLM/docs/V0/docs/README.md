...
├── RKV_EQUIVALENCE_FIX.md         # ⭐ 相位计算公式修正（2026-02-01）
├── MLR_FIX.md                     # ⭐ MLR (Extra Term) 公式修正（2026-02-01）
├── FP32_EQUIVALENCE_FIX.md        # ⭐ Triton-PyTorch 等价性修正（2026-02-01）
└── archive/                       # 归档（原始文档，供参考）
```
...
**当前状态**（2026-02-01）：
- ✅ 核心打分 Triton kernel 已实现并通过验证（33/33 测试通过）
- ✅ PyTorch 实现已完成，与 R-KV 等价性验证通过
- ✅ 数学公式优化已完成（相位计算修正、MLR 公式修正）
- ⏸️ vLLM 集成和完整端到端测试进行中
...
| 想了解... | 阅读文档 |
|----------|---------|
| 相位计算公式修正 | [RKV_EQUIVALENCE_FIX.md](RKV_EQUIVALENCE_FIX.md) |
| MLR 公式修正 | [MLR_FIX.md](MLR_FIX.md) |
| Triton-PyTorch 等价性修正 | [FP32_EQUIVALENCE_FIX.md](FP32_EQUIVALENCE_FIX.md) |
