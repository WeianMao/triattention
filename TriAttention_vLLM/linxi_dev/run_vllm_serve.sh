...
if is_truthy "${ENABLE_TRIATTENTION}"; then
  ...
  unset TRIATTN_RUNTIME_SPARSE_STATS_PATH TRIATTN_RUNTIME_KV_BUDGET
  unset TRIATTN_RUNTIME_DIVIDE_LENGTH TRIATTN_RUNTIME_WINDOW_SIZE
  unset TRIATTN_RUNTIME_PRUNING_MODE TRIATTN_RUNTIME_LOG_DECISIONS
  unset TRIATTN_RUNTIME_ENABLE_EXPERIMENTAL_KV_COMPACTION
