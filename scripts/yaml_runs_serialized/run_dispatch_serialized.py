#!/usr/bin/env python3
"""Dispatch DeepConf example runners across multiple GPUs using YAML configs."""
...
MODE_SPECS: Dict[str, ModeSpec] = {
    ...
    "offline": ModeSpec(
        name="offline",
        script_relpath=Path("development/example_offline_serialized.py"),
...
def parse_args(argv: Iterable[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument("--mode", choices=sorted(MODE_SPECS.keys()), default="online")
