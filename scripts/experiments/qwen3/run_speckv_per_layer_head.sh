...
usage() {
  cat <<USAGE
Usage: bash scripts/qwen3/run_triattention_per_layer_head.sh [--budget N]

Runs per-layer+per-head TriAttention pruning for Qwen3-8B on aime24/aime25/math500.
