...
usage() {
  cat <<USAGE
Usage: bash scripts/distill_qwen7b/run_triattention_per_layer_head.sh [--budget N]

Runs per-layer+per-head TriAttention pruning for DeepSeek-R1-Distill-Qwen-7B on aime24/aime25/math500.
