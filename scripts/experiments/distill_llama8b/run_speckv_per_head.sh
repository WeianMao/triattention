...
usage() {
  cat <<USAGE
Usage: bash scripts/distill_llama8b/run_speckv_per_head.sh [--budget N]

Runs SpeckV per-head pruning for DeepSeek-R1-Distill-Llama-8B on aime24/aime25/math500. Passing
